...
2. Ikuti struktur di `library/docs/rules.md`.
3. Jika mengubah seri tertentu, ikuti `library/<series>/docs/rules.md`.
4. Pastikan lesson memenuhi struktur minimal.

## Checklist Sebelum Commit

- Struktur folder valid sesuai `library/docs/rules.md`.
